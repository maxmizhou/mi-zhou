 ...
 * @author Mi
 */
public class MiExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		MiExpressionRootObject rootObject = new MiExpressionRootObject(method, args, target, targetClass, targetMethod);
