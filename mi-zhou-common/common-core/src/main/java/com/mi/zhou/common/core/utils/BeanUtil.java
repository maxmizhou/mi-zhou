...
import com.mi.zhou.common.core.beans.BeanDiff;
import com.mi.zhou.common.core.beans.MiBeanCopier;
import com.mi.zhou.common.core.beans.MiBeanMap;
import com.mi.zhou.common.core.convert.MiConverter;
import com.mi.zhou.common.core.exception.ServiceException;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		MiBeanCopier copier = MiBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		MiBeanCopier copier = MiBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		MiBeanCopier copier = MiBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new MiConverter(sourceClazz, targetClazz));
		return to;
	}
