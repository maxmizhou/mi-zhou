...
import com.mi.zhou.common.core.utils.ReflectUtil;
 ...
 * @author Mi
 */
class MiBeanMapEmitter extends ClassEmitter {
	private static final Type BEAN_MAP = TypeUtils.parseType(MiBeanMap.class.getName());
	...
	public MiBeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
		super(v);
